...
const SIGNATURES: ReadonlyArray<Signature> = [
  // Images
  {
    ...
    mime: 'image/png',
    ext: 'png',
    match: (h) => startsWithBytes(h, 0, [0x89, 0x50, 0x4e, 0x47, 0x0d, 0x0a, 0x1a, 0x0a]),
  },
  {
    name: 'JPEG',
    mime: 'image/jpeg',
    ext: 'jpg',
    match: (h) => startsWithBytes(h, 0, [0xff, 0xd8, 0xff]),
  },
  ...
  { name: 'BMP', mime: 'image/bmp', ext: 'bmp', match: (h) => startsWithBytes(h, 0, [0x42, 0x4d]) },
  {
    ...
    mime: 'image/tiff',
    ext: 'tif',
    match: (h) => startsWithBytes(h, 0, [0x49, 0x49, 0x2a, 0x00]),
  },
  {
    name: 'TIFF (big-endian)',
    mime: 'image/tiff',
    ext: 'tif',
    match: (h) => startsWithBytes(h, 0, [0x4d, 0x4d, 0x00, 0x2a]),
  },
  {
    name: 'WebP',
    mime: 'image/webp',
    ext: 'webp',
    match: (h) => asciiAt(h, 0, 'RIFF') && asciiAt(h, 8, 'WEBP'),
  },
  {
    name: 'AVIF',
    mime: 'image/avif',
    ext: 'avif',
    match: (h) => asciiAt(h, 4, 'ftypavif') || asciiAt(h, 4, 'ftypavis'),
  },
  {
    name: 'HEIC',
    mime: 'image/heic',
    ext: 'heic',
    match: (h) =>
      asciiAt(h, 4, 'ftypheic') ||
      asciiAt(h, 4, 'ftypheix') ||
      asciiAt(h, 4, 'ftyphevc') ||
      asciiAt(h, 4, 'ftypmif1'),
  },
  {
    name: 'ICO',
    mime: 'image/x-icon',
    ext: 'ico',
    match: (h) => startsWithBytes(h, 0, [0x00, 0x00, 0x01, 0x00]),
  },
  ...
  { name: 'RTF', mime: 'application/rtf', ext: 'rtf', match: (h) => asciiAt(h, 0, '{\\rtf') },
  {
    ...
    ext: 'ps',
    match: (h) => asciiAt(h, 0, '%!PS'),
  },
  {
    name: 'EPUB',
    mime: 'application/epub+zip',
    ext: 'epub',
    match: (h) => asciiAt(h, 0, 'PK') && asciiAt(h, 30, 'mimetypeapplication/epub+zip'),
  },
  ...
  // Archives / containers
  {
    ...
    ext: 'zip',
    match: (h) => asciiAt(h, 0, 'PK') || asciiAt(h, 0, 'PK') || asciiAt(h, 0, 'PK'),
  },
  {
    name: 'GZIP',
    mime: 'application/gzip',
    ext: 'gz',
    match: (h) => startsWithBytes(h, 0, [0x1f, 0x8b]),
  },
  { name: 'TAR', mime: 'application/x-tar', ext: 'tar', match: (h) => asciiAt(h, 257, 'ustar') },
  {
    ...
    ext: '7z',
    match: (h) => startsWithBytes(h, 0, [0x37, 0x7a, 0xbc, 0xaf, 0x27, 0x1c]),
  },
  {
    name: 'RAR (v1.5+)',
    mime: 'application/vnd.rar',
    ext: 'rar',
    match: (h) => startsWithBytes(h, 0, [0x52, 0x61, 0x72, 0x21, 0x1a, 0x07]),
  },
  {
    name: 'XZ',
    mime: 'application/x-xz',
    ext: 'xz',
    match: (h) => startsWithBytes(h, 0, [0xfd, 0x37, 0x7a, 0x58, 0x5a, 0x00]),
  },
  ...
  { name: 'MP3 (ID3)', mime: 'audio/mpeg', ext: 'mp3', match: (h) => asciiAt(h, 0, 'ID3') },
  {
    ...
    mime: 'audio/mpeg',
    ext: 'mp3',
    match: (h) => h[0] === 0xff && (h[1]! & 0xe0) === 0xe0,
  },
  ...
  { name: 'OGG', mime: 'audio/ogg', ext: 'ogg', match: (h) => asciiAt(h, 0, 'OggS') },
  {
    ...
    mime: 'audio/wav',
    ext: 'wav',
    match: (h) => asciiAt(h, 0, 'RIFF') && asciiAt(h, 8, 'WAVE'),
  },
  {
    name: 'AIFF',
    mime: 'audio/aiff',
    ext: 'aiff',
    match: (h) => asciiAt(h, 0, 'FORM') && asciiAt(h, 8, 'AIFF'),
  },
  ...
  // Video
  {
    ...
    match: (h) =>
      asciiAt(h, 4, 'ftypmp4') ||
      asciiAt(h, 4, 'ftypisom') ||
      asciiAt(h, 4, 'ftypiso2') ||
      asciiAt(h, 4, 'ftypdash'),
  },
  {
    name: 'QuickTime',
    mime: 'video/quicktime',
    ext: 'mov',
    match: (h) => asciiAt(h, 4, 'ftypqt') || asciiAt(h, 4, 'moov'),
  },
  {
    name: 'WebM/Matroska',
    mime: 'video/webm',
    ext: 'webm',
    match: (h) => startsWithBytes(h, 0, [0x1a, 0x45, 0xdf, 0xa3]),
  },
  {
    name: 'AVI',
    mime: 'video/x-msvideo',
    ext: 'avi',
    match: (h) => asciiAt(h, 0, 'RIFF') && asciiAt(h, 8, 'AVI '),
  },
  ...
  { name: 'WOFF2', mime: 'font/woff2', ext: 'woff2', match: (h) => asciiAt(h, 0, 'wOF2') },
  {
    ...
    mime: 'font/ttf',
    ext: 'ttf',
    match: (h) => startsWithBytes(h, 0, [0x00, 0x01, 0x00, 0x00]),
  },
  ...
  { name: 'XML', mime: 'application/xml', ext: 'xml', match: (h) => asciiAt(h, 0, '<?xml') },
  {
    ...
    ext: 'html',
    match: (h) =>
      /^\s*<(!doctype html|html|head|body)/i.test(new TextDecoder().decode(h.slice(0, 64))),
  },
  {
    name: 'SVG',
    mime: 'image/svg+xml',
    ext: 'svg',
    match: (h) => /^\s*(<\?xml[^>]*\?>\s*)?<svg\b/i.test(new TextDecoder().decode(h.slice(0, 256))),
  },
  ...
  // Executables
  {
    ...
    ext: 'class',
    match: (h) => startsWithBytes(h, 0, [0xca, 0xfe, 0xba, 0xbe]),
  },
  {
    name: 'ELF',
    mime: 'application/x-elf',
    ext: '',
    match: (h) => startsWithBytes(h, 0, [0x7f, 0x45, 0x4c, 0x46]),
  },
  {
    name: 'Mach-O (64-bit)',
    ...
    ext: '',
    match: (h) =>
      startsWithBytes(h, 0, [0xcf, 0xfa, 0xed, 0xfe]) ||
      startsWithBytes(h, 0, [0xfe, 0xed, 0xfa, 0xcf]),
  },
  {
    name: 'PE/COFF (Windows)',
    mime: 'application/vnd.microsoft.portable-executable',
    ext: 'exe',
    match: (h) => asciiAt(h, 0, 'MZ'),
  },
  {
    name: 'WebAssembly',
    mime: 'application/wasm',
    ext: 'wasm',
    match: (h) => startsWithBytes(h, 0, [0x00, 0x61, 0x73, 0x6d]),
  },
];
