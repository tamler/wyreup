...
Wyreup is a library of 53 privacy-first file tools that run locally — in the browser or on the user's machine. This skill teaches Claude when and how to call Wyreup.
