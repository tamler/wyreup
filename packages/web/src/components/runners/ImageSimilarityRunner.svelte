...
<style>
  ...
  .pair-row.score--match .pair-row__score { color: var(--accent); font-weight: 600; }
  ...
  .cluster__thumb { width: 48px; height: 48px; object-fit: cover; border-radius: var(--radius-sm); border: 1px solid var(--accent); }
