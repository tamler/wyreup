...
export const VARIANT_MAP: Record<string, RunnerVariant> = {
  ...
  'color-blind-simulator': 'SimpleImageRunner',
  ...
  'text-summarize-pro': 'TextInputRunner',
  'text-translate-pro': 'TextInputRunner',
  ...
  'css-minify': 'TextInputRunner',
  'html-formatter': 'TextInputRunner',
  'html-minify': 'TextInputRunner',
  'sql-formatter': 'TextInputRunner',
  'xml-formatter': 'TextInputRunner',
  'xml-to-json': 'TextInputRunner',
  'json-to-xml': 'TextInputRunner',
